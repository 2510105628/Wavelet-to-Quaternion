...
parser.add_argument('--module', '-m', metavar='NAME', default='mamba_vision_T', help='module architecture (default: mamba_vision_T)')
...
# Define mamba_vision_T module with 224 x 224 resolution
...
print('{} module succesfully created !'.format(args.model))

image = torch.rand(1, 3, 754, 234).cuda() # place image on cuda

model = model.cuda() # place module on cuda
