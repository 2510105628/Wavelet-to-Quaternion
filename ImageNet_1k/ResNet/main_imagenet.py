...
parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet18',
                    help='module architecture (default: resnet18)')
...
parser.add_argument('--resume', default='/home/wfz/lxh/DLpython/ResNet/ckpts/imagenet-resnet50-seed0/checkpoint.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
parser.add_argument('-e', '--evaluate', dest='evaluate', action='store_true',
                    help='evaluate module on validation set')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print("module [%s] - params: %.6fM" % (args.arch, params / 1e6))
    print("module [%s] - FLOPs: %.6fG" % (args.arch, flops / 1e9))
    ...
    # Data loading Wavelet_to_Quaternion
