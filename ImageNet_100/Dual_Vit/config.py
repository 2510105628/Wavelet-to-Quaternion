...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'wavevit'
# Model name
_C.MODEL.NAME = 'wavevit_small_224'
...
# WaveVit_Small parameters
_C.MODEL.WaveVit = CN()
_C.MODEL.WaveVit.IN_CHANS = 3
_C.MODEL.WaveVit.DEPTHS = [2, 2, 9, 2]
_C.MODEL.WaveVit.stem_hidden_dim = 32
_C.MODEL.WaveVit.embed_dims=[64, 128, 320, 448]
_C.MODEL.WaveVit.num_heads=[2, 4, 10, 14]
_C.MODEL.WaveVit.mlp_ratios=[8, 8, 4, 4]
_C.MODEL.WaveVit.depths=[3, 4, 6, 3]
_C.MODEL.WaveVit.sr_ratios=[4, 2, 1, 1]
# -----------------------------------------------------------------------------
# Training settings
# -----------------------------------------------------------------------------
_C.TRAIN = CN()
...
_C.OUTPUT = './outputs/exp_dual_qhwtv2_432'
