...
from module.dualvit import dualvit_s
from module.qhwt_dualvit import dualvit_s as qhwt_dualvit_s
...
def main(config):
    ...
    # module = torch.nn.parallel.DistributedDataParallel(module, device_ids=[config.LOCAL_RANK], broadcast_buffers=False)
