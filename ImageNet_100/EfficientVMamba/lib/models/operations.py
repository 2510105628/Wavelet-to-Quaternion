...
OPS = OrderedDict()
OPS['id'] = lambda inp, oup, t, stride, kwargs: Identity(in_channels=inp, out_channels=oup, kernel_size=1,
                                                         stride=stride, **kwargs)

'''MixConv'''
OPS['ir_mix_se'] = lambda inp, oup, t, stride, kwargs: InvertedResidualMixConv(in_channels=inp, out_channels=oup,
                                                                               dw_kernel_size=3,
                                                                               stride=stride, act_fn=HSwish,
                                                                               expand_ratio=t, se_ratio=0.25,
                                                                               se_gate_fn=HSigmoid, **kwargs)
OPS['ir_mix_nse'] = lambda inp, oup, t, stride, kwargs: InvertedResidualMixConv(in_channels=inp, out_channels=oup,
                                                                                dw_kernel_size=3,
                                                                                stride=stride, act_fn=HSwish,
                                                                                expand_ratio=t, se_ratio=None, **kwargs)

'''MobileNet V2 Inverted Residual'''
OPS['ir_3x3_se'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                        dw_kernel_size=3,
                                                                        stride=stride, act_fn=HSwish, expand_ratio=t,
                                                                        se_ratio=0.25, se_gate_fn=HSigmoid, **kwargs)
OPS['ir_5x5_se'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                        dw_kernel_size=5,
                                                                        stride=stride, act_fn=HSwish, expand_ratio=t,
                                                                        se_ratio=0.25, se_gate_fn=HSigmoid, **kwargs)
OPS['ir_7x7_se'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                        dw_kernel_size=7,
                                                                        stride=stride, act_fn=HSwish, expand_ratio=t,
                                                                        se_ratio=0.25, se_gate_fn=HSigmoid, **kwargs)
OPS['ir_3x3_nse'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                         dw_kernel_size=3,
                                                                         stride=stride, act_fn=HSwish, expand_ratio=t,
                                                                         se_ratio=None, **kwargs)
OPS['ir_5x5_nse'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                         dw_kernel_size=5,
                                                                         stride=stride, act_fn=HSwish, expand_ratio=t,
                                                                         se_ratio=None, **kwargs)
OPS['ir_7x7_nse'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                         dw_kernel_size=7,
                                                                         stride=stride, act_fn=HSwish, expand_ratio=t,
                                                                         se_ratio=None, **kwargs)
OPS['ir_3x3'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                     dw_kernel_size=3,
                                                                     stride=stride, act_fn=nn.ReLU, expand_ratio=t,
                                                                     se_ratio=None, **kwargs)
OPS['ir_5x5'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                     dw_kernel_size=5,
                                                                     stride=stride, act_fn=nn.ReLU, expand_ratio=t,
                                                                     se_ratio=None, **kwargs)
OPS['ir_7x7'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                     dw_kernel_size=7,
                                                                     stride=stride, act_fn=nn.ReLU, expand_ratio=t,
                                                                     se_ratio=None, **kwargs)
...
OPS['conv1x1'] = lambda inp, oup, t, stride, kwargs: ConvBnAct(in_channels=inp, out_channels=oup, kernel_size=1,
                                                               stride=stride, **kwargs)
OPS['conv3x3'] = lambda inp, oup, t, stride, kwargs: ConvBnAct(in_channels=inp, out_channels=oup, kernel_size=3,
                                                               stride=stride, **kwargs)
...
'''for NAS-Bench-Macro'''
OPS['ir_3x3_t3'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                        dw_kernel_size=3,
                                                                        stride=stride, act_fn=nn.ReLU, expand_ratio=3,
                                                                        se_ratio=None, **kwargs)
OPS['ir_5x5_t6'] = lambda inp, oup, t, stride, kwargs: InvertedResidual(in_channels=inp, out_channels=oup,
                                                                        dw_kernel_size=5,
                                                                        stride=stride, act_fn=nn.ReLU, expand_ratio=6,
                                                                        se_ratio=None, **kwargs)
OPS['ID'] = lambda inp, oup, t, stride, kwargs: Identity(in_channels=inp, out_channels=oup, kernel_size=1,
                                                         stride=stride, **kwargs)
...
==========================
"""
OPS['shuffle_3x3_se'] = lambda inp, oup, t, stride, kwargs: ShufflenetBlock(inp, oup, ksize=3, stride=stride,
                                                                            activation='HSwish', use_se=True)
OPS['shuffle_5x5_se'] = lambda inp, oup, t, stride, kwargs: ShufflenetBlock(inp, oup, ksize=5, stride=stride,
                                                                            activation='HSwish', use_se=True)
OPS['shuffle_7x7_se'] = lambda inp, oup, t, stride, kwargs: ShufflenetBlock(inp, oup, ksize=7, stride=stride,
                                                                            activation='HSwish', use_se=True)
OPS['shuffle_x_se'] = lambda inp, oup, t, stride, kwargs: ShufflenetBlock(inp, oup, ksize='x', stride=stride,
                                                                          activation='HSwish', use_se=True)
    ...
    def __init__(self, inp, oup, ksize, stride, activation='ReLU', use_se=False, **kwargs):
        ...
        if ksize != 'x':
            branch_main = [
                ...
                # dw
                nn.Conv2d(base_mid_channels, base_mid_channels, ksize, stride, pad, groups=base_mid_channels,
                          bias=False),
                nn.BatchNorm2d(base_mid_channels),
                # pw-linear
...
==========================
"""
OPS['avg_pool_3x3'] = lambda inp, oup, t, stride, kwargs: nn.AvgPool2d(3, stride=stride, padding=1,
