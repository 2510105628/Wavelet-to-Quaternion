...
_C.DATA.TRAIN_PATH = "/home/ac/data/wfz/imagenet100/train"
# Number of data loading threads
_C.DATA.TEST_PATH = "/home/ac/data/wfz/imagenet100/val"
...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'EfficientVMamba'
# Model name
_C.MODEL.NAME = 'EfficientVMamba-B'
...
# _C.MODEL.VSSM.WINDOWSIZE= 2

# MobileVSSM parameters
_C.MODEL.MobileVSSM = CN()
_C.MODEL.MobileVSSM.PATCH_SIZE = 4
_C.MODEL.MobileVSSM.IN_CHANS = 3
_C.MODEL.MobileVSSM.DEPTHS = [2, 2, 9, 2]
_C.MODEL.MobileVSSM.EMBED_DIM = 96
_C.MODEL.MobileVSSM.D_STATE = 16
_C.MODEL.MobileVSSM.DT_RANK = "auto"
_C.MODEL.MobileVSSM.SSM_RATIO = 2.
_C.MODEL.MobileVSSM.SHARED_SSM = False
_C.MODEL.MobileVSSM.SOFTMAX = False
_C.MODEL.MobileVSSM.MLP_RATIO = 4.
_C.MODEL.MobileVSSM.PATCH_NORM = True
_C.MODEL.MobileVSSM.DOWNSAMPLE = "v2"
_C.MODEL.MobileVSSM.WINDOWSIZE= 2
