...
if __name__ == "__main__":
    ...
    print(x.total())
    parms(model)
    # path_csv = './ImageNet-100-18-3407.csv'
    # path_csv = './ImageNet-100-34-114514.csv'
    path_csv = './ImageNet-100-50-qhwtv2_1.csv'
    # path_pkl = './ImageNet-100-18.pkl'
    # path_pkl = './ImageNet-100-34.pkl'
    path_pkl = './ImageNet-100-34.pkl'
    # resNet-18 128 128 resNet-34 128 256 resNet-50 256 256
    batchSize_train = 128
    batchSize_val = 128
    # write header
