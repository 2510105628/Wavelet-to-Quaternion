...
class QHWTD(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, wt_kernel_size=3, wt_levels=2, wt_type='db1'):
        ...
        self.wavelet_convs = nn.ModuleList(
            ...
            [QuaternionConv(in_channels, in_channels, wt_kernel_size, 1, (wt_kernel_size - 1) // 2, bias=True) for _ in
        ...
        self.downSample = nn.Sequential(
            nn.Conv2d(in_channels + in_channels // 4, out_channels, kernel_size, 2, (kernel_size - 1) // 2),
