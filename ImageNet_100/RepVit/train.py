...
from models.RepVit import repvit_m0_6, repvit_m0_9
from models.RepVit_wt import repvit_m0_6 as repvit_m0_6_wt, repvit_m0_9 as repvit_m0_9_wt
import utils
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='repvit_m0_6_wt_2', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/ac/data/wfz/imagenet100', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--resume', default='/home/wfz/lxh/RepVit/checkpoints/repvit_m0_6_wt_2/2025_06_17_23_11_05/checkpoint_160.pth', help='resume from checkpoint')
    ...
    parser.add_argument('--distributed', action='store_true', default=False,
                        help='Enable distributed training (default: False)')
